...
with(this){return _c('p',[_v("This project is based on the AddressBook-Level3 project by the "),_c('a',{attrs:{"href":"https://se-education.org/"}},[_v("SE-EDU initiative")]),_v(".\nKeyContacts uses the following libraries: "),_c('a',{attrs:{"href":"https://openjfx.io/"}},[_v("JavaFX")]),_v(", "),_c('a',{attrs:{"href":"https://github.com/FasterXML/jackson"}},[_v("Jackson")]),_v(", "),_c('a',{attrs:{"href":"https://github.com/junit-team/junit5"}},[_v("JUnit5")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The undo/redo mechanism is facilitated by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedStudentDirectory")]),_v(". It extends "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("StudentDirectory")]),_v(" with an undo/redo history, stored internally as an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("studentDirectoryStateList")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(". Additionally, it implements the following operations:")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedStudentDirectory#commit()")]),_v(" — Saves the current student directory state in its history.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedStudentDirectory#undo()")]),_v(" — Restores the previous student directory state from its history.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedStudentDirectory#redo()")]),_v(" — Restores a previously undone student directory state from its history.")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("These operations are exposed in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" interface as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitStudentDirectory()")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#undoStudentDirectory()")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#redoStudentDirectory()")]),_v(" respectively.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 1. The user launches the application. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedStudentDirectory")]),_v(" will be initialized with the initial student directory state, and the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" pointing to that single student directory state.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 2. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 5")]),_v(" command to delete the 5th student in the student directory. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(" calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitStudentDirectory()")]),_v(", causing the modified state of the student directory after the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 5")]),_v(" command executes to be saved in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("studentDirectoryStateList")]),_v(", and the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" is shifted to the newly inserted student directory state.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 3. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/David …​")]),_v(" to add a new student. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" command calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitStudentDirectory()")]),_v(", causing another modified student directory state to be saved into the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("studentDirectoryStateList")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 4. The user now decides that adding the student was a mistake, and decides to undo that action by executing the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" command. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" command will call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#undoStudentDirectory()")]),_v(", which will shift the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" once to the left, pointing it to the previous student directory state, and restores the student directory to that state.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redo")]),_v(" command does the opposite — it calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#redoStudentDirectory()")]),_v(", which shifts the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" once to the right, pointing to the previously undone state, and restores the student directory to that state.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 5. The user then decides to execute the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(". Commands that do not modify the student directory, such as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(", will not call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitStudentDirectory()")]),_v(". Thus, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("studentDirectoryStateList")]),_v(" remains unchanged.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 6. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clear")]),_v(", which calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitStudentDirectory()")]),_v(". Since the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" is not pointing at the end of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("studentDirectoryStateList")]),_v(", all student directory states after the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" will be purged. Reason: It no longer makes sense to redo the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/David …​")]),_v(" command. This is the behavior that most modern desktop applications follow.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Current:")]),_v(" Saves the entire student directory.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Easy to implement.")]),_v(" "),_c('li',[_v("Cons: May have performance issues in terms of memory usage.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative:")]),_v(" Individual command knows how to undo/redo by\nitself.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Will use less memory (e.g. for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", just save the student being deleted).")]),_v(" "),_c('li',[_v("Cons: We must ensure that the implementation of each individual command are correct.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Manage students' information and schedules faster than a typical mouse/GUI driven app")]),_v(" "),_c('li',[_v("Accommodate students who need to reschedule, making for a flexible scheduling tool")]),_v(" "),_c('li',[_v("Display grade level and piano pieces, enabling piano teachers to prepare for lessons.")])])}
},function anonymous(
) {
...
with(this){return _c('h4',{attrs:{"id":"use-case-add-a-student-uc01"}},[_v("Use case: Add a student (UC01)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-add-a-student-uc01","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a student, including their details.")])]),_v(" "),_c('li',[_c('p',[_v("KeyContacts adds the student and notifies the user.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("1b. KeyContacts detects an existing student that is a duplicate of the student the user is trying to add.\n"),_c('ul',[_c('li',[_v("1b1. KeyContacts alerts the user that the student already exists.")]),_v(" "),_c('li',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"use-case-edit-a-student-uc02"}},[_v("Use case: Edit a student (UC02)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-edit-a-student-uc02","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to edit a student with new data.")])]),_v(" "),_c('li',[_c('p',[_v("KeyContacts edits the student and notifies the user.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('h4',{attrs:{"id":"use-case-delete-a-student-uc03"}},[_v("Use case: Delete a student (UC03)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-delete-a-student-uc03","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to delete a student.")])]),_v(" "),_c('li',[_c('p',[_v("KeyContacts deletes the student from the list and notifies the user.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('h4',{attrs:{"id":"use-case-clear-the-student-directory-uc04"}},[_v("Use case: Clear the student directory (UC04)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-clear-the-student-directory-uc04","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests clear the student directory.")])]),_v(" "),_c('li',[_c('p',[_v("KeyContacts clears the student directory.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"use-case-view-a-list-of-all-students-uc05"}},[_v("Use case: View a list of all students (UC05)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-view-a-list-of-all-students-uc05","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view a list of all students.")])]),_v(" "),_c('li',[_c('p',[_v("KeyContacts displays the list of students to the user.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"use-case-find-a-student-uc06"}},[_v("Use case: Find a student (UC06)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-find-a-student-uc06","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to find a student, providing one or more search terms.")])]),_v(" "),_c('li',[_c('p',[_v("KeyContacts displays the students that fit the search term.")])]),_v(" "),_c('li',[_c('p',[_v("User scrolls through the displayed list to find the student they are looking for.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('h4',{attrs:{"id":"use-case-sort-students-uc07"}},[_v("Use case: Sort students (UC07)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-sort-students-uc07","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to sort the students, providing the sorting details.")])]),_v(" "),_c('li',[_c('p',[_v("KeyContacts displays the students sorted in the given order.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('h4',{attrs:{"id":"use-case-schedule-a-student-s-regular-lesson-uc08"}},[_v("Use case: Schedule a student's regular lesson (UC08)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-schedule-a-student-s-regular-lesson-uc08","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to schedule a student's regular lesson, including the day of the week, starting time and ending time.")])]),_v(" "),_c('li',[_c('p',[_v("KeyContacts schedules the regular lesson at the given day and time period for the student with the associated index and notifies the user.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_v("1b. KeyContacts detects a lesson that clashes with the regular lesson.\n"),_c('ul',[_c('li',[_v("1b1. KeyContacts informs the user of the clash.")]),_v(" "),_c('li',[_v("1b2. User enters new data.")]),_v(" "),_c('li',[_v("Steps 1b1-1b2 are repeated until a clash is no longer detected.")]),_v(" "),_c('li',[_v("Use case resumes from step 2.")])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"use-case-assign-piano-piece-to-a-student-uc09"}},[_v("Use case: Assign piano piece to a student (UC09)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-assign-piano-piece-to-a-student-uc09","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to assign piano pieces to a student.")])]),_v(" "),_c('li',[_c('p',[_v("KeyContacts assigns the piano pieces to the student and notifies the user.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('h4',{attrs:{"id":"use-case-unassign-piano-pieces-from-a-student-uc10"}},[_v("Use case: Unassign piano pieces from a student (UC10)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-unassign-piano-pieces-from-a-student-uc10","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to unassign piano pieces from a student.")])]),_v(" "),_c('li',[_c('p',[_v("KeyContacts unassigns the piano pieces from the student and notifies the user.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. KeyContacts detects an error in the entered data.\n"),_c('ul',[_c('li',[_v("1a1. KeyContacts requests for the correct data.")]),_v(" "),_c('li',[_v("1a2. User enters a new day, start time and or end time.")]),_v(" "),_c('li',[_v("Steps 1a1-1a2 are repeated until the data entered are correct.")]),_v(" "),_c('li',[_v("Use case resumes from step 2.")])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"use-case-view-the-calendar-uc11"}},[_v("Use case: View the calendar (UC11)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-view-the-calendar-uc11","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view the calendar for a specified week.")])]),_v(" "),_c('li',[_c('p',[_v("KeyContacts displays the calendar view for the given week.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('h4',{attrs:{"id":"use-case-schedule-a-make-up-lesson-uc12"}},[_v("Use case: Schedule a make-up lesson (UC12)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-schedule-a-make-up-lesson-uc12","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to schedule a make-up lesson.")])]),_v(" "),_c('li',[_c('p',[_v("KeyContacts schedules the make-up lesson and notifies the user.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_v("1b. KeyContacts detects a clash with the make-up lesson.\n"),_c('ul',[_c('li',[_v("1b1. KeyContacts informs the user of the clash.")]),_v(" "),_c('li',[_v("1b2. User enters a new date and or time.")]),_v(" "),_c('li',[_v("Steps 1b1-1b2 are repeated until no clashes are detected.")]),_v(" "),_c('li',[_v("Use case resumes from step 2.")])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"use-case-cancel-a-lesson-session-uc13"}},[_v("Use case: Cancel a lesson session (UC13)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-cancel-a-lesson-session-uc13","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to cancel a lesson session.")])]),_v(" "),_c('li',[_c('p',[_v("KeyContacts cancels the lesson session and notifies the user.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('h4',{attrs:{"id":"use-case-uncancel-a-lesson-session-uc14"}},[_v("Use case: Uncancel a lesson session (UC14)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-uncancel-a-lesson-session-uc14","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to uncancel a lesson session.")])]),_v(" "),_c('li',[_c('p',[_v("KeyContacts uncancels the lesson session and notifies the user.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_v("1b. KeyContacts detects a make-up lesson that clashes with the uncancelled lesson.\n"),_c('ul',[_c('li',[_v("1b1. KeyContacts informs the user of the clash.")]),_v(" "),_c('li',[_v("1b2. "),_c('mark',[_c('span',{staticClass:"underline"},[_v("User requests to cancel the clashing make-up lesson (UC13)")])]),_v(".")]),_v(" "),_c('li',[_v("Use case resumes from step 1.")])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"use-case-view-the-list-of-commands-uc15"}},[_v("Use case: View the list of commands (UC15)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-view-the-list-of-commands-uc15","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view the list of commands.")])]),_v(" "),_c('li',[_c('p',[_v("KeyContacts displays the dialog box with a link to the user guide.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"use-case-undo-the-last-command-uc16"}},[_v("Use case: Undo the last command (UC16)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-undo-the-last-command-uc16","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to undo the last command.")])]),_v(" "),_c('li',[_c('p',[_v("KeyContacts undoes the last command.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('h4',{attrs:{"id":"use-case-redo-the-last-undone-command-uc17"}},[_v("Use case: Redo the last undone command (UC17)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-redo-the-last-undone-command-uc17","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to redo the last undone command.")])]),_v(" "),_c('li',[_c('p',[_v("KeyContacts redoes the last undone command.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('h4',{attrs:{"id":"use-case-exit-uc18"}},[_v("Use case: Exit (UC18)"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-exit-uc18","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to exit KeyContacts.")])]),_v(" "),_c('li',[_c('p',[_v("KeyContacts closes.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('strong',[_v("Cross-Platform Compatibility")]),_v(": Should work on any "),_c('em',[_v("Mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_c('strong',[_v("Optimised for CLI Users")]),_v(": A user with above average typing speed (50 words per minute) for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_c('strong',[_v("CLI Responsiveness")]),_v(": Commands executed through the CLI should respond within 1 second under normal load (e.g. with 100 contacts).")]),_v(" "),_c('li',[_c('strong',[_v("UI Responsiveness")]),_v(": The UI must remain responsive when updating large datasets, such as when displaying a list of contacts, without causing delays of more than 1 second in interactions.")]),_v(" "),_c('li',[_c('strong',[_v("Data Persistence")]),_v(": Data must persist between sessions, even during unexpected shutdowns and crashes.")]),_v(" "),_c('li',[_c('strong',[_v("Error Recovery")]),_v(": In cases of missing or corrupted data files, the app should seamlessly handle errors without crashing.")]),_v(" "),_c('li',[_c('strong',[_v("Data Security")]),_v(": The application should ensure that private contact details are not accidentally exposed or shared without the user’s consent.")]),_v(" "),_c('li',[_c('strong',[_v("Minimal Learning Curve")]),_v(": The system should be easy to learn for users familiar with basic command-line applications, providing clear error messages and help documentation for new users.")]),_v(" "),_c('li',[_c('strong',[_v("Scalability")]),_v(": The system design should allow for future fields or features without major architectural changes.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Cancel a scheduled lesson")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("cancel 1 dt/04-11-2024 st/12:00")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(": The first student's lesson on November 04, 2024, at 12:00 is canceled.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("cancel 2 dt/18-10-2024 st/16:00")]),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(": The second student's lesson on October 18, 2024, at 16:00 is canceled.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Note:")]),_v(" Team size 5")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('strong',[_v("Update the checking for clashing lessons such that past make-up lessons do not affect the scheduling of regular lessons.")]),_v(" Currently, make-up lessons in the past cause clashes when scheduling regular lessons. The planned enhancement will cause clashes to only be detected with lessons that occur in the future.")])])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"2"}},[_c('li',[_c('strong',[_v("Allow regular lessons to stretch across multiple days (e.g 22:00 to 24:00).")]),_v(" Currently, lessons are unable to span multiple dates as they store a date/day, start time and end time. This can be expanded to allow lessons that stretch across multiple days by splitting the date/day field into start date/day and end date/day fields.")])])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"3"}},[_c('li',[_c('strong',[_v("Improve sorting to compare alphabetically instead of by ASCII value.")]),_v(" Sorting is currently done by ASCII values but this may be unintuitive behaviour. The planned enhancement will have lower-case and upper-case letters treated the same, meaning the sort will be case-insensitive.")])])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"4"}},[_c('li',[_c('strong',[_v("Allow the editing of existing group names.")]),_v(" Currently, there is no way to update the name of a group across an entire group of students. The planned enhancement would be to add a new command to perform this.")])])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"5"}},[_c('li',[_c('strong',[_v("Improve the clarity of the undo feature by specifying the command that was undone.")]),_v(" The undo feature currently has no indication of what command was undone. The planned enhancement is to show the exact command that was undone in the returned message from running the command.")])])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"6"}},[_c('li',[_c('strong',[_v("Improve the calendar view to display long names more clearly.")]),_v(" The calendar view currently struggles to display long names, resulting in ellipses and an inability to view the entire student name or group name. The planned enhancement is to make the student or group name more clearly visible by wrapping the text.")])])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"7"}},[_c('li',[_c('strong',[_v("Improve calendar view to indicate if a regular lesson was cancelled for that week.")]),_v(" The calendar view currently has no indication of when a student's regular lesson is if it is cancelled on the week that is being viewed. This can cause confusion among the tutors as they may observe a clash with the lesson despite not seeing it in the schedule. The planned enhancement is to show all regular lessons but with an indication of its cancellation status.")])])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"8"}},[_c('li',[_c('strong',[_v("Increase minimum width of application.")]),_v(" Currently, the minimum width causes the group tag to be cut off. The planned enhancement is to increase this minimum size to a point that will not have this issue.")])])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"9"}},[_c('li',[_c('strong',[_v("Gracefully handle long group names.")]),_v(" Currently, a long group name will obscure the student's name. The planned enhancement is to restrict the group name to 20 characters long.")])])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"10"}},[_c('li',[_c('strong',[_v("Improve the clarity of the redo feature by specifying the command that was redone.")]),_v(" Currently, the redo command return result is unclear. The planned enhancement will be to include the command being redone in the redo command result.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Mon, 11 Nov 2024, 22:18:11 GMT+8]")])])])}
}];
